                ...
                db.withConnection(connection -> {
                    PreparedStatement statement = connection.prepareStatement(
                            "SELECT m.*, " +
                                    ...
                                    "FROM msms m " +
                                    "LEFT JOIN msms_peaks ci ON m.msms_id = mp.msms_id " +
                                    "LEFT JOIN msms_reference ci ON m.msms_id = mr.msms_id " +
                                    "WHERE m.msms_id = ?");
        ...
        return CompletableFuture.supplyAsync(() ->
                db.withConnection(connection -> {
                    ...
                    if (rowsInserted > 0 && !msms.getCreatedPeak().isEmpty()) {
                        ...
                        peakStatement.setInt(4, generatedMsmsId);
                    ...
                    if (rowsInserted > 0 && !msms.getCreatedRef().isEmpty()) {
                        ...
                        refStatement.setInt(4, generatedMsmsId);
        ...
        return CompletableFuture.supplyAsync(() ->
                db.withConnection(connection -> {
                    ...
                    if (rowsDeleted > 0) {
                        ...
                        PreparedStatement refStatement = connection.prepareStatement(
                                "DELETE FROM msms_reference WHERE compound_id = ?");
